    ...
    export default {
        ...
        methods: {
            finduserImage(){
                ...
                axios.get('http://192.168.1.106:8080/backend/portrait/customerPortrait/findAllCusPortrait', {headers:{
                        token: tokenStr
                    }}).then( res => {
                ...
                axios.get('http://192.168.1.106:8080/backend/portrait/customerPortrait/findAllCusPortrait/1/10').then(res => {
            ...
            getuserImage(){
                ...
                axios.put('http://192.168.1.106:8080/backend/portrait/customerPortrait/giveAllCusPortrait', {headers:{
                        token: tokenStr
                    }}).then( res => {
                    console.log(res.data)
                    console.log("拿到画像")
            ...
            handleCurrentChange(currentPage){
                ...
                if(this.flag===1){
                    axios.get('http://192.168.1.106:8080/backend/portrait/customerPortrait/findCusPortraitByCondition/'+currentPage+'/'
                        +this.queryInfo.pageSize).then(res => {
                        console.log(res.data.data)
                        that.tableData = res.data.data
            ...
            handleSizeChange(pageSize) {
                ...
                if(this.flag===1){
                    axios.get('http://192.168.1.106:8080/backend/portrait/customerPortrait/findCusPortraitByCondition/'
                        +this.queryInfo.pageNum+'/'+pageSize).then(res => {
                        // console.log(res.data.data)
                        that.tableData = res.data.data
            ...
            submitList() {
                ...
                console.log(midlist)
                console.log("提交表单")
                axios.get('http://192.168.1.106:8080/backend/portrait/customerPortrait/findCusPortraitByLabel', {
                    params: midlist,
                }).then( res => {
                    console.log(res.data)
                    that.tableData = res.data.data;
            ...
            submitButton() {
                ...
                axios.get('http://192.168.1.106:8080/backend/portrait/customerPortrait/findCusPortraitByCondition/1/10', {
                    params:midlist,
                }).then( res => {
                    that.tableData = res.data.data;
            ...
            resetButton(){
                ...
                axios.get('http://192.168.1.106:8080/backend/portrait/customerPortrait/findCusPortraitByCondition', {headers:{
                        token: this.tokenStr
                    }}).then( res => {
                    // console.log(res.data)
                    that.tableData = res.data.data;
            ...
            giveAllCusCatePortrait(){
                this.loading=true
                const that = this
                axios.put('http://192.168.1.106:8080/backend/portrait/customerPortrait/giveAllCusCatePortrait').then( res => {
                    console.log(res.msg)
                    console.log("11111")
                    this.loading=false
                    this.$message({
            ...
            giveAllCusSalePortrait(){
                this.loading=true
                const that = this
                axios.put('http://192.168.1.106:8080/backend/portrait/customerPortrait/giveAllCusSalePortrait').then( res => {
                    console.log(res.msg)
                    console.log("22222")
                    this.loading=false
                    this.$message({
            ...
            giveAllCusTimePortrait(){
                this.loading=true
                const that = this
                axios.put('http://192.168.1.106:8080/backend/portrait/customerPortrait/giveAllCusTimePortrait').then( res => {
                    console.log(res.msg)
                    console.log("33333")
                    this.loading=false
                    this.$message({
            ...
            giveAllCusValPortrait(){
                this.loading=true
                const that = this
                axios.put('http://192.168.1.106:8080/backend/portrait/customerPortrait/giveAllCusValPortrait').then( res => {
                    console.log(res.msg)
                    console.log("44444")
                    this.loading=false
                    this.$message({
            ...
            giveAllCusRegPortrait(){
                this.loading=true
                const that = this
                axios.put('http://192.168.1.106:8080/backend/portrait/customerPortrait/giveAllCusRegPortrait').then( res => {
                    console.log(res.msg)
                    console.log("55555")
                    this.loading=false
                    this.$message({
            ...
            giveAllCusPalPortrait(){
                this.loading=true
                const that = this
                axios.put('http://192.168.1.106:8080//backend/portrait/customerPortrait/giveAllCusPalPortrait').then( res => {
                    console.log(res.msg)
                    console.log("66666")
                    this.loading=false
                    this.$message({
            ...
            giveAllCusRepurchasePortrait(){
                this.loading=true
                const that = this
                axios.put('http://192.168.1.106:8080//backend/portrait/customerPortrait/giveAllCusRepurchasePortrait').then( res => {
                    console.log(res.msg)
                    console.log("77777")
                    this.loading=false
                    this.$message({
            ...
            giveAllCusReputationPortrait(){
                this.loading=true
                const that = this
                axios.put('http://192.168.1.106:8080/backend/portrait/customerPortrait/giveAllCusReputationPortrait').then( res => {
                    console.log(res.msg)
                    console.log("88888")
                    this.loading=false
                    this.$message({
            ...
            giveAllCusPromotionPortrait(){
                this.loading=true
                const that = this
                axios.put('http://192.168.1.106:8080/backend/portrait/customerPortrait/giveAllCusPromotionPortrait').then( res => {
                    console.log(res.msg)
                    console.log("99999")
                    this.loading=false
                    this.$message({
            ...
            giveAllCusCyclePortrait(){
                this.loading=true
                const that = this
                axios.put('http://192.168.1.106:8080/backend/portrait/customerPortrait/giveAllCusCyclePortrait').then( res => {
                    console.log(res.msg)
                    console.log("！！！！")
                    this.loading=false
                    this.$message({
            ...
            giveAllCusProp1Portrait(){
                this.loading=true
                const that = this
                axios.put('http://192.168.1.106:8080/backend/portrait/customerPortrait/giveAllCusProp1Portrait').then( res => {
                    console.log(res.msg)
                    console.log("？？？")
                    this.loading=false
                    this.$message({
            ...
            giveAllCusProp2Portrait(){
                this.loading=true
                const that = this
                axios.put('http://192.168.1.106:8080/backend/portrait/customerPortrait/giveAllCusProp2Portrait').then( res => {
                    console.log(res.msg)
                    console.log("？!？!？!")
                    this.loading=false
                    this.$message({
            ...
            giveAllCusProp3Portrait(){
                axios.put('http://192.168.1.106:8080/backend/portrait/customerPortrait/giveAllCusProp3Portrait').then( res => {
                    console.log(res.msg)
                    console.log("？!？!？!")
                    this.loading=false
                    this.$message({
            ...
            giveAllCusProp4Portrait(){
                axios.put('http://192.168.1.106:8080/backend/portrait/customerPortrait/giveAllCusProp4Portrait').then( res => {
                    console.log(res.msg)
                    console.log("mmmmm")
                    this.loading=false
                    this.$message({
            ...
            giveAllCusProp5Portrait(){
                axios.put('http://192.168.1.106:8080/backend/portrait/customerPortrait/giveAllCusProp5Portrait').then( res => {
                    console.log(res.msg)
                    console.log("mmmmm")
                    this.loading=false
                    this.$message({
