    ...
    <div>
        ...
        <div>
            <el-table :data="tableData" border style="width: 200%"   @sort-change="changeTableSort" :default-sort = "{prop: 'updateTime', order: 'descending'}">
                ...
                <el-table-column fixed prop="updateTime" label="创建时间" width="" >
                </el-table-column>
                <el-table-column
                        fixed
                        label="操作"
            ...
            <el-dialog
                ...
                <el-form :model="addForm" >
                    ...
                    <el-row>
                        <el-col :span="12">
                            <el-form-item label="最低购买金额："  placeholder="单位：万元"  :label-width="formLabelWidth" v-model="addForm.totalPurchaseAmountLow">
                                <el-input v-model="addForm.totalPurchaseAmountLow" autocomplete="off"  size="small"></el-input>
                            </el-form-item>
                        </el-col>
                        <el-col :span="12">
                            <el-form-item label="最高购买金额：" placeholder="单位：万元" :label-width="formLabelWidth" v-model="addForm.totalPurchaseAmountHigh">
