...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            //     const that = this
            //     const datalist = []
            //     axios.get('http://localhost:8080/backend/label/findLabelValByName/'+currentPage+'/'+size).then(res => {
            ...
            //     const that = this
            //     const datalist = []
            //     axios.get('http://localhost:8080/backend/label/findLabelValByName/'+current+'/'+size).then(res => {
            //         // console.log(res.data.data)
            //         this.tableData = res.data.data
            //     }).catch()
            // },
